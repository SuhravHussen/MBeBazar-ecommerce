...
export const catagories: iCategories[] = [
  {
    primaryIcon: <Image loading="eager" src="/images/drawer/vagetables.webp" alt="food" height={20} width={20} />,
  ...
  {
    primaryIcon: <Image loading="eager" src="/images/drawer/seafood.webp" alt="food" height={20} width={20} />,
    primaryText: 'Fresh Seafood',
    collapses: [{ text: 'Fresh Seafood', icon: <GiFoodChain /> }],
  },
  {
    primaryIcon: <Image loading="eager" src="/images/drawer/cooking.webp" alt="food" height={20} width={20} />,
  ...
  {
    primaryIcon: <Image loading="eager" src="/images/drawer/breakfast.webp" alt="food" height={20} width={20} />,
  ...
  {
    primaryIcon: <Image loading="eager" src="/images/drawer/drinks.webp" alt="food" height={20} width={20} />,
    primaryText: 'Drinks',
    collapses: [
  ...
  {
    primaryIcon: <Image loading="eager" src="/images/drawer/milk.webp" alt="food" height={20} width={20} />,
  ...
  {
    primaryIcon: <Image loading="eager" src="/images/drawer/organic.webp" alt="food" height={20} width={20} />,
    primaryText: 'Organic Food',
    collapses: [{ text: 'Organic Food', icon: <MdNaturePeople /> }],
  },
  {
    primaryIcon: <Image loading="eager" src="/images/drawer/honey.webp" alt="food" height={20} width={20} />,
    primaryText: 'Honey',
  ...
  {
    primaryIcon: <Image loading="eager" src="/images/drawer/jam.webp" alt="food" height={20} width={20} />,
    primaryText: 'Jam & Jelly',
    collapses: [{ text: 'Jam & Jelly', icon: <GiJelly /> }],
  },
  {
    primaryIcon: <Image loading="eager" src="/images/drawer/snack.webp" alt="food" height={20} width={20} />,
    primaryText: 'Snacks',
    collapses: [
  ...
  {
    primaryIcon: <Image loading="eager" src="/images/drawer/biscuits.webp" alt="food" height={20} width={20} />,
  ...
  {
    primaryIcon: <Image loading="eager" src="/images/drawer/tools.webp" alt="food" height={20} width={20} />,
  ...
  {
    primaryIcon: <Image loading="eager" src="/images/drawer/babycare.webp" alt="food" height={20} width={20} />,
  ...
  {
    primaryIcon: <Image loading="eager" src="/images/drawer/beauty.webp" alt="food" height={20} width={20} />,
