...
export default function ShippingDetails({ control, errors, user, register, setShippingMethod }: iProps) {
  return (
    <DetailsContainer heading="Shipping Details" number="02">
      ...
      />
      <ShippingMethod setShippingMethod={setShippingMethod} register={register} control={control} />
    </DetailsContainer>
  );
}
